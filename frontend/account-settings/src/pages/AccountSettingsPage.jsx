...
const PHONE_CODES = [
  { code: "+1", name: "US/Canada" }, { code: "+7", name: "Russia" },
  { code: "+33", name: "France" }, { code: "+34", name: "Spain" },
  { code: "+44", name: "UK" }, { code: "+49", name: "Germany" },
  { code: "+55", name: "Brazil" }, { code: "+61", name: "Australia" },
  { code: "+81", name: "Japan" }, { code: "+82", name: "South Korea" },
  { code: "+86", name: "China" }, { code: "+90", name: "Turkey" },
  { code: "+91", name: "India" }, { code: "+92", name: "Pakistan" },
  { code: "+234", name: "Nigeria" }, { code: "+254", name: "Kenya" },
  { code: "+966", name: "Saudi Arabia" }, { code: "+971", name: "UAE" },
];
            ...
            <div className={styles.section}>
              ...
              <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <label style={{ fontSize: 'var(--font-sm)', fontWeight: 500, color: 'var(--text-primary)' }}
                    htmlFor="phoneCountryCode">Code</label>
                  <select id="phoneCountryCode" name="phoneCountryCode"
                    ...
                    style={{
                      ...
                      border: '1.5px solid var(--border-color)', borderRadius: 'var(--radius-input)',
                      fontFamily: 'var(--font-family)', fontSize: 'var(--font-sm)',
                      color: 'var(--text-primary)', outline: 'none', cursor: 'pointer', width: '120px',
                    }}>
                ...
                <div style={{ flex: 1 }}>
                  <Input id="phoneNumber" name="phoneNumber" type="tel"
                    label="Phone number (optional)" placeholder="98765 43210"
